<div class="app-menu">
    ...
    <div class="scrollbar">
        ...
        <div class="user-box text-center">
            ...
            <div class="dropdown">
                <a href="javascript: void(0);" class="dropdown-toggle h5 mb-1 d-block" data-bs-toggle="dropdown">Avocat</a>
            ...
            <p class="text-muted mb-0">Avocat Head</p>
        </div>
        ...
        <ul class="menu">
           ...
           <!-- <li class="menu-item">
            ...
            <li class="menu-item">
                <a href="{{ route('admin.blank-page') }}" class="menu-link">
            ...
            <li class="menu-item">
                <a href="#" class="menu-link">
                    <span class="menu-icon"><i class="mdi mdi-checkbox-blank-outline"></i></span>
                    <span class="menu-text"> Mes stagiaires </span>
                </a>
            </li>
            <li class="menu-item">
                <a href="#" class="menu-link">
